...
public class Demo2 {
    public static void main(String[] args) throws ExecutionException, InterruptedException, IOException {
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter("testjava/day24/time.txt", true));
        writer.write(s1);
        writer.newLine();
        writer.write(s2);
        writer.newLine();
...
class CloneFile implements Callable {
    ...
    public Object call() throws Exception {
        ...
        BufferedReader reader = new BufferedReader(new FileReader("testjava/day24/src.txt"));
        BufferedWriter writer = new BufferedWriter(new FileWriter("testjava/day24/" + Thread.currentThread().getName() + ".txt", true));

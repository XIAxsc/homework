...
public class Demo4 {
    public static void main(String[] args) {
        clone c1 = new clone("t1", "src/month1/day21/Demo1.java", "testjava/day22/Demo1.java");
        clone c2 = new clone("t2", "src/month1/day21/Demo2.java", "testjava/day22/Demo2.java");
        clone c3 = new clone("t3", "src/month1/day21/Demo3.java", "testjava/day22/Demo3.java");

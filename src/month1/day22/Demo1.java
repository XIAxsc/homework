...
public class Demo1 {
    public static void main(String[] args) {
        clone c1 = new clone("s1", "src/month1/day21/Demo1.java", "test/day22/Demo1.java");
        clone c2 = new clone("s2", "src/month1/day21/Demo2.java", "test/day22/Demo2.java");
        clone c3 = new clone("s3", "src/month1/day21/Demo3.java", "test/day22/Demo3.java");
